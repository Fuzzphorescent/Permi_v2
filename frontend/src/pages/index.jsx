...
export default function Home() {
  ...
  return (
    <div className="flex h-screen flex-col font-philo text-yellow">
      <div className=" flex flex-row w-screen h-20 justify-between flex-row font-color bg-black text-yellow text-6xl">
...
// function Test() {
//   return (
//     <main className="wrapper flex min-h-screen flex-row items-center justify-between p-24">
//       <div className="navbar z-10 w-full max-w-5xl items-center justify-between font-mono text-sm lg:flex">
